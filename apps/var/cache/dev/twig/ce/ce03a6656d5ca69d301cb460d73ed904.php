...
/* catentity/index.html.twig */
class __TwigTemplate_6cc39a0601a68e3503fe9580d25f23c1 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "catentity/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "catentity/index.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "catentity/index.html.twig", 1);
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Listado de Entidades"), "html", null, true);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 7
        echo "<h1>";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Lista de Entidades"), "html", null, true);
        echo "</h1>
...
<a class=\"btn btn-primary\" role=\"button\" aria-disabled=\"true\" href=\"";
        // line 17
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("catentity_new");
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Nueva Entidad"), "html", null, true);
        echo "</a>
...
\$(document).ready(function() {
  \$('#tblist').DataTable({
    ...
    \"ajax\":\"";
        // line 34
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("catentity_list");
        echo "\",
    \"order\": [[ 0, \"desc\" ]],
    \"columns\":[
      {\"data\":\"name\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.id) {\$(nTd).html(\"<a href='/catentity/\"+oData.id+\"/edit'>\"+oData.name+\"</a>\");}}},
      {\"data\":\"description\"},
      ...
      {\"data\":\"id\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.id) {
        \$(nTd).html(
          ...
          \"<a href='/catentity/\"+oData.id+\"/edit'><i class='bi bi-pencil'></i></a> / <a href='/catentity/\"+oData.id+\"/delete'><i class='bi bi-trash'></i></a>\"
        );
        }}},
    ]
   });   
...
";
    ...
    {
        return "catentity/index.html.twig";
    }
...
{% block title %}{{ 'Listado de Entidades' | trans }}{% endblock %}

{% block body %}
<h1>{{ 'Lista de Entidades' | trans }}</h1>
...
<a class=\"btn btn-primary\" role=\"button\" aria-disabled=\"true\" href=\"{{url('catentity_new')}}\">{{ 'Nueva Entidad' | trans }}</a>
<table id=\"tblist\" class=\"table table-sm table-striped table-bordered table-hover\">
<thead>
<tr>
 ...
 <th data-field=\"opcionCatEntity\">{{'Opcion' | trans}}</th>
</tr>
</thead>
</table>
...
{% endblock %}
", "catentity/index.html.twig", "/home/userdesa/www/reportesundav/apps/templates/catentity/index.html.twig");
    }
}
