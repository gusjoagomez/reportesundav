...
/* syscompanynowork/index.html.twig */
class __TwigTemplate_8b4a8c81fcc9b45265a5379165386bf7 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "syscompanynowork/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "syscompanynowork/index.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "syscompanynowork/index.html.twig", 1);
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Listado de SysCompanynowork"), "html", null, true);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 7
        echo "<h1>";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Lista de SysCompanynowork"), "html", null, true);
        echo "</h1>
...
<a class=\"btn btn-primary\" role=\"button\" aria-disabled=\"true\" href=\"";
        // line 17
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("syscompanynowork_new");
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Nuevo SysCompanynowork"), "html", null, true);
        echo "</a>
...
<tr>
 ...
 <th data-field=\"deletedAt\">";
        ...
        echo "</th>
 <th data-field=\"opcionSysCompanynowork\">";
        // line 32
...
\$(document).ready(function() {
  \$('#tblist').DataTable({
    ...
    \"ajax\":\"";
        // line 42
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("syscompanynowork_list");
        echo "\",
    \"order\": [[ 0, \"desc\" ]],
    \"columns\":[
      {\"data\":\"id\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.id) {\$(nTd).html(\"<a href='/syscompanynowork/\"+oData.id+\"/edit'>\"+oData.id+\"</a>\");}}},
      {\"data\":\"updatedAt\"},
      {\"data\":\"todate\"},
      {\"data\":\"description\"},
      {\"data\":\"createdBy\"},
      ...
      {\"data\":\"deletedBy\"},
      {\"data\":\"deletedAt\"},
      {\"data\":\"id\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.id) {\$(nTd).html(\"<a href='/syscompanynowork/\"+oData.id+\"/delete'><i class='bi bi-trash'></i></a>\");}}},
    ]
   });   
});
</script>
...
";
    ...
    {
        return "syscompanynowork/index.html.twig";
    }
...
{% block title %}{{ 'Listado de SysCompanynowork' | trans }}{% endblock %}

{% block body %}
<h1>{{ 'Lista de SysCompanynowork' | trans }}</h1>
...
<a class=\"btn btn-primary\" role=\"button\" aria-disabled=\"true\" href=\"{{url('syscompanynowork_new')}}\">{{ 'Nuevo SysCompanynowork' | trans }}</a>
<table id=\"tblist\" class=\"table table-sm table-striped table-bordered table-hover\">
<thead>
<tr>
 ...
 <th data-field=\"opcionSysCompanynowork\">{{'Opcion' | trans}}</th>
</tr>
</thead>
</table>
...
\$(document).ready(function() {
  \$('#tblist').DataTable({
    ...
    \"ajax\":\"{{url('syscompanynowork_list')}}\",
    \"order\": [[ 0, \"desc\" ]],
    \"columns\":[
      {\"data\":\"id\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.id) {\$(nTd).html(\"<a href='/syscompanynowork/\"+oData.id+\"/edit'>\"+oData.id+\"</a>\");}}},
      {\"data\":\"updatedAt\"},
...
{% endblock %}
", "syscompanynowork/index.html.twig", "/home/ntbdesa/www/reportesundav/apps/templates/syscompanynowork/index.html.twig");
    }
}
