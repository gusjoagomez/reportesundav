...
/* medreports/index.html.twig */
class __TwigTemplate_6f482791ed3cf179f20b906c0d5040ae extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "medreports/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "medreports/index.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "medreports/index.html.twig", 1);
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Listado de MedReports"), "html", null, true);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 7
        echo "<h1>";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Lista de MedReports"), "html", null, true);
        echo "</h1>
...
<a class=\"btn btn-primary\" role=\"button\" aria-disabled=\"true\" href=\"";
        // line 17
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("medreports_new");
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Nuevo MedReports"), "html", null, true);
        echo "</a>
...
<tr>
 ...
 <th data-field=\"params\">";
        ...
        echo "</th>
 <th data-field=\"txtquery\">";
        // line 24
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Txtquery"), "html", null, true);
        echo "</th>
 ...
 <th data-field=\"name\">";
        ...
        echo "</th>
 <th data-field=\"opcionMedReports\">";
        // line 29
...
\$(document).ready(function() {
  \$('#tblist').DataTable({
    ...
    \"ajax\":\"";
        // line 39
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("medreports_list");
        echo "\",
    \"order\": [[ 0, \"desc\" ]],
    \"columns\":[
      {\"data\":\"id\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.id) {\$(nTd).html(\"<a href='/medreports/\"+oData.id+\"/edit'>\"+oData.id+\"</a>\");}}},
      {\"data\":\"description\"},
      {\"data\":\"params\"},
      {\"data\":\"txtquery\"},
      {\"data\":\"orderlist\"},
      ...
      {\"data\":\"companyId\"},
      {\"data\":\"name\"},
      {\"data\":\"id\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.id) {\$(nTd).html(\"<a href='/medreports/\"+oData.id+\"/delete'><i class='bi bi-trash'></i></a>\");}}},
    ]
   });   
});
</script>
...
";
    ...
    {
        return "medreports/index.html.twig";
    }
    ...
    {
        return array (  181 => 39,  177 => 38,  165 => 29,  161 => 28,  157 => 27,  153 => 26,  149 => 25,  145 => 24,  141 => 23,  137 => 22,  133 => 21,  124 => 17,  120 => 15,  111 => 13,  107 => 12,  98 => 10,  94 => 9,  88 => 7,  78 => 6,  59 => 4,  36 => 1,);
    }
...
{% block title %}{{ 'Listado de MedReports' | trans }}{% endblock %}

{% block body %}
<h1>{{ 'Lista de MedReports' | trans }}</h1>
...
<a class=\"btn btn-primary\" role=\"button\" aria-disabled=\"true\" href=\"{{url('medreports_new')}}\">{{ 'Nuevo MedReports' | trans }}</a>
<table id=\"tblist\" class=\"table table-sm table-striped table-bordered table-hover\">
<thead>
<tr>
 ...
 <th data-field=\"txtquery\">{{ 'Txtquery' | trans}}</th>
 ...
 <th data-field=\"opcionMedReports\">{{'Opcion' | trans}}</th>
</tr>
</thead>
</table>
...
{% endblock %}
", "medreports/index.html.twig", "/home/ntbdesa/www/reportesundav/apps/templates/medreports/index.html.twig");
    }
}
