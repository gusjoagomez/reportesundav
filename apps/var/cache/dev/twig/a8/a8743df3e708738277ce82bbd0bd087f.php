...
/* medqueue/index.html.twig */
class __TwigTemplate_8ebdcc18804de18a66b9fb4d142a6ceb extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "medqueue/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "medqueue/index.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "medqueue/index.html.twig", 1);
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Listado de Turneros"), "html", null, true);
...
<h2>";
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Lista de Turneros"), "html", null, true);
        echo "</h2>
...
<a class=\"btn btn-primary\" role=\"button\" aria-disabled=\"true\" href=\"";
        // line 19
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("medqueue_new", ["company" => twig_get_attribute($this->env, $this->source, (isset($context["company"]) || array_key_exists("company", $context) ? $context["company"] : (function () { throw new RuntimeError('Variable "company" does not exist.', 19, $this->source); })()), "id", [], "any", false, false, false, 19)]), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Nuevo Turnero"), "html", null, true);
        echo "</a>
...
\$(document).ready(function() {
  \$('#tblist').DataTable({
    ...
    \"ajax\":\"";
        // line 36
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("medqueue_list", ["company" => twig_get_attribute($this->env, $this->source, (isset($context["company"]) || array_key_exists("company", $context) ? $context["company"] : (function () { throw new RuntimeError('Variable "company" does not exist.', 36, $this->source); })()), "id", [], "any", false, false, false, 36)]), "html", null, true);
        echo "\",
    \"order\": [[ 0, \"desc\" ]],
    \"columns\":[
      {\"data\":\"name\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.id) {\$(nTd).html(\"<a href='/medqueue/\"+oData.id+\"/edit'>\"+oData.name+\"</a>\");}}},
      {\"data\":\"branch.name\"},
      {\"data\":\"active\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.active==1){\$(nTd).html(\"✅\");}else{\$(nTd).html(\"❌\");}}},
      {\"data\":\"id\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.id) {\$(nTd).html(\"<a href='/medqueue/\"+oData.id+\"/delete'><i class='bi bi-trash'></i></a>\");}}},
    ]
   });   
});
</script>
...
";
    ...
    {
        return "medqueue/index.html.twig";
    }
    ...
    {
        return array (  169 => 36,  165 => 35,  153 => 26,  149 => 25,  145 => 24,  141 => 23,  132 => 19,  129 => 18,  120 => 16,  116 => 15,  107 => 13,  103 => 12,  98 => 10,  91 => 8,  88 => 7,  78 => 6,  59 => 4,  36 => 1,);
    }
...
{% block title %}{{ 'Listado de Turneros' | trans }}{% endblock %}

{% block body %}

<h1>{{ 'Empresa:' | trans }} {{ company.name }}</h1>
<hr>
<h2>{{ 'Lista de Turneros' | trans }}</h2>
...
<a class=\"btn btn-primary\" role=\"button\" aria-disabled=\"true\" href=\"{{url('medqueue_new',{'company': company.id})}}\">{{ 'Nuevo Turnero' | trans }}</a>
<table id=\"tblist\" class=\"table table-sm table-striped table-bordered table-hover\">
<thead>
<tr>
...
\$(document).ready(function() {
  \$('#tblist').DataTable({
    ...
    \"ajax\":\"{{url('medqueue_list',{'company': company.id})}}\",
    \"order\": [[ 0, \"desc\" ]],
    \"columns\":[
      {\"data\":\"name\",fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {if(oData.id) {\$(nTd).html(\"<a href='/medqueue/\"+oData.id+\"/edit'>\"+oData.name+\"</a>\");}}},
      {\"data\":\"branch.name\"},
...
{% endblock %}
", "medqueue/index.html.twig", "/home/ntbdesa/www/reportesundav/apps/templates/medqueue/index.html.twig");
    }
}
